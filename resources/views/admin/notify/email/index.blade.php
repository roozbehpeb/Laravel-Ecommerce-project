                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.notify.email-file.index', $email->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-file"></i> فایل ضمیمه</a>
                ...
                success : function(response){
                    if(response.status){
                        if(response.checked){
                            ...
                            successToast_Active('ایمیل  با موفقیت فعال شد')
                        }
                        else{
                            element.prop('checked', false);
                            successToast_Deactive('ایمیل  با موفقیت غیر فعال شد')
                        }
                    }
                    else{
