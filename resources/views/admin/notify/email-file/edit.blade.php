                        ...
                        <section class="row">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    <label for="file">عنوان فایل</label>
                                    <div class="d-block py-2">{{ $file->original_name }}</div>
                                </div>
                            ...
                            <section class="col-2">
                                <div class="form-group">
                                    <label for="file">دسترسی فایل</label>
                                    <select name="access" id="" class="form-control form-control-sm"
                                        id="status" disabled>
                                        <option value="0" @if (old('access', $file->access) == 0) selected @endif>عممومی
                                        </option>
                                        <option value="1" @if (old('access', $file->access) == 1) selected @endif>خصوصی
                                        </option>
                                    </select>
                                </div>
                            </section>
