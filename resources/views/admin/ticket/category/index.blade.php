                        ...
                        <tr>
                            ...
                            <td>
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="{{ $ticketCategory->id }}"
                                    ...
                                    <label class="custom-control-label" for="{{ $ticketCategory->id }}"></label>
                                </div>
                            </td>
                ...
                success: function(response) {
                    if (response.status) {
                        if (response.checked) {
                            ...
                            successToast_Active('وضعیت دسته بندی تیکت ها با موفقیت فعال شد')
                        } else {
                            element.prop('checked', false);
                            successToast_Deactive('وضعیت دسته بندی تیکت ها غیر فعال شد')
                        }
                    } else {
