...
use App\Http\Controllers\admin\ticket\TicketCategoryController;
...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('store')->group(function () {
            ...
            Route::delete('/destroy/{store}', [StoreController::class, 'destroy'])->name('admin.market.store.destroy');
        });
    });
    ...
    Route::prefix('content')->namespace('Content')->group(function () {
        ...
        Route::prefix('comment')->group(function () {
            ...
            Route::get('/answer/{comment}', [ContentCommentController::class, 'answer'])->name('admin.content.comment.answer');
        });
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function () {
        ...
        Route::prefix('priority')->group(function () {
         ...
         Route::prefix('admin')->group(function () {
            ...
            Route::get('/edit/{admin}', [TicketAdminController::class, 'set'])->name('admin.ticket.admin.set');
        });
